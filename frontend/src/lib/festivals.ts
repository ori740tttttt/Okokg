...
export const festivals: Festival[] = [
  ...
  { id: "carini-crocifisso", name: "Festa del SS. Crocifisso · Patrono di Carini", place: "Carini", province: "PA", start: "2026-09-12", end: "2026-09-14", dateLabel: "12–14 settembre 2026", category: "religiosa", icon: "✝️", description: "Festa patronale di Carini in onore del Santissimo Crocifisso: tre giorni di processioni, luminarie e fuochi d'artificio.", curiosity: "Carini è celebre per il suo castello e la leggenda della 'Baronessa di Carini'." },
